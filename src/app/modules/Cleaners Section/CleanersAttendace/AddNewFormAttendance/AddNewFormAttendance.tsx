...
const AddNewFormAttendance = ({ handlecleanerAttendanceform, ParentData }: Props) => {
    LocalBaseURL()
    ...
    const handleCreateCleanerAttendance = async () => {
    ...
    return (
        <div className="p-8" style={ContainerCss}>
            ...
            <div className="p-5 mr-auto">
                ...
                >
                    <span className='indicator-label' onClick={handleCreateCleanerAttendance}>Create Attendance</span>
                </button>
            </div>
        </div>
    )
}
export default AddNewFormAttendance
