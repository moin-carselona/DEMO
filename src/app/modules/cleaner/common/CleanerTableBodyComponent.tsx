        ...
        return (
          <tr  >
            ...
            >
              ...
              >
                {cleanerStat?.cleaner_details?.first_name + " - " + ((cleanerStat?.cleaner_details?.distance + " Away"))}
                <br />
                <div className='d-flex flex-row mb-1  justify-content-between align-items-center position-sticky' >
                  <div className='w-100 mt-2'>
                    <div className='d-flex'>
                      <span className='badge badge-light-dark fs-8 fw-bold me-2 '> ( PW:  {cleanerStat?.cleaner_details?.projected_points?.currweek.total_point ? cleanerStat?.cleaner_details?.projected_points?.currweek.total_point : 0} )</span>
                      <span className='badge badge-light-dark fs-8 fw-bold me-2 '> ( CW: {cleanerStat?.cleaner_details?.projected_points?.prevweek.total_point ? cleanerStat?.cleaner_details?.projected_points?.prevweek.total_point : 0} ) </span>
