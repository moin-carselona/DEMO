...
import { ContainerCss, PopCloseFormNotification, PopCloseFormNotificationPtag, HeaderCss, IdCss, ID_inputCss, Create_BtnCss, Desc_InputCss } from '../../../../consts/Styles/CssCom';
interface Props {
    PopUpcountryListBTN: () => void
}
let IDS:any = "";

const AddNewCountryListForm = ({ PopUpcountryListBTN }: Props) => {
    ...
    const handleCreatecountryList = async () => {
    ...
    return (
        <div className="p-8" style={ContainerCss}>
            ...
            <div className="p-5 mr-auto">
                ...
                >
                    <span className='indicator-label' onClick={handleCreatecountryList}>Add Society</span>
                </button>
            </div>
        </div>
    )
}
export default AddNewCountryListForm
