...
const AddNewStatesForm = ({ PopUpStatesBTN }: Props) => {
    ...
    const handleCreatemasterresouces = async () => {
    ...
    return (
        <div className="p-8" style={ContainerCss}>
            ...
            <div className="p-5 mr-auto">
                ...
                >
                    <span className='indicator-label' onClick={handleCreatemasterresouces}>Add Society</span>
                </button>
            </div>
        </div>
    )
}
export default AddNewStatesForm
