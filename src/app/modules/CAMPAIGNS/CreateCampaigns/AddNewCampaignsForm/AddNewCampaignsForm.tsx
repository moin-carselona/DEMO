...
const AddNewCampaignsForm = ({ PopUpCampaignsBTN }: Props) => {
    ...
    const handlCreateCampaignssubmit = async () => {
    ...
    return (
        <div className="p-8" style={ContainerCss}>
            ...
            <div className="p-5 mr-auto">
                ...
                >
                    <span className='indicator-label' onClick={handlCreateCampaignssubmit}>Add Society</span>
                </button>
            </div>
        </div>
    )
}
export default AddNewCampaignsForm
