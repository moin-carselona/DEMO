...
export const PopCloseFormNotificationPtag: CSS.Properties = { textAlign: "center", width: "5%", marginLeft: "95%", fontWeight: "700", color: "white", background: "#519ff7", border: "2px solid #519ff7", borderRadius: "50%", cursor: "pointer" }
