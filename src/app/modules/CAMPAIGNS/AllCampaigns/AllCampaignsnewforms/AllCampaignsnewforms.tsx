...
const AllCampaignsnewforms = ({ PopUpallCampaignsBTN }: Props) => {
    ...
    const handlecreateallcampaigns = async () => {
      
    }
    // to close pop up form
    const handleClose = () => {
        PopUpallCampaignsBTN()
    }
    React.useEffect(() => {
    ...
    return (
        <div className="p-8" style={ContainerCss}>
            ...
            <div className="p-5 mr-auto">
                ...
                >
                    <span className='indicator-label' onClick={handlecreateallcampaigns}>Add Society</span>
                </button>
            </div>
        </div>
    )
}
export default AllCampaignsnewforms
