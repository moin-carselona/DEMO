...
const ProfileHeaders: React.FC = () => {
  const location = useLocation()
  console.log('location moin', location);
  const data = "/crafted/pages/profile/overview"
          ...
          <ul className='nav nav-stretch nav-line-tabs nav-line-tabs-2x border-transparent fs-5 fw-bolder flex-nowrap'>
            <li className='nav-item'>
              <Link
                className={
                  ...
                  (location.pathname === '/crafted/pages/tickets/address' && 'active')
                }
                to='/crafted/pages/tickets/address'
              >
                Address
              </Link>
            </li>
            <li className='nav-item'>
              <Link
                className={
                  `nav-link text-active-primary me-6 ` +
                  (location.pathname === '/crafted/pages/tickets/subscription' && 'active')
                }
