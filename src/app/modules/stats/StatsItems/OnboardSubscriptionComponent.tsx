...
import { onboardingSubscriptionsColumns } from "../../apps/user-management/users-list/table/columns/_onboardingSubscriptionsColumns";

const OnboardSubscriptionComponent = () => {
    const API = "https://adminapi.carselonadaily.com/api/admin/getPendingOnboardingList";
    ...
    const columns = useMemo(() => onboardingSubscriptionsColumns, [])
...
export default OnboardSubscriptionComponent;