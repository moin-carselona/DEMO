...
import { kitSubscriptionColumns } from "../../apps/user-management/users-list/table/columns/_kitSubscriptionColumns";

type Props = {
    newVehicleOnboards: any,
    isLoading: boolean
}

const NewVehicleStatsComponent: FC<Props> = (props: Props) => {
    const { newVehicleOnboards } = props;
    const API = "https://adminapi.carselonadaily.com/api/admin/getKitSubscriptions";
    ...
    const columns = useMemo(() => kitSubscriptionColumns, [])
    ...
    React.useEffect(() => {
        ...
        axios.get('https://adminapi.carselonadaily.com/api/admin/getSupervisorList').then((response) => {
        ...
        axios.get('https://adminapi.carselonadaily.com/api/admin/getCleanerList').then((response) => {
...
export default NewVehicleStatsComponent;