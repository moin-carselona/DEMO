...
import { onDemandColumns } from "../../apps/user-management/users-list/table/columns/_onDemandColumns";

const SameDayStatsComponent: FC = () => {
    ...
    const columns = useMemo(() => onDemandColumns, [])
    ...
    const API = 'https://adminapi.carselonadaily.com/api/admin/allactiveondemandswithpayment';
...
export default SameDayStatsComponent;