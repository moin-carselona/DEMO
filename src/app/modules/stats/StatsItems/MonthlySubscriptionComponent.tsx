...
import { monthlySubscriptionColumns } from "../../apps/user-management/users-list/table/columns/_monthlySubscriptionColumns";

const MonthlySubscriptionComponent = () => {
    ...
    const columns = useMemo(() => monthlySubscriptionColumns, [])
...
export default MonthlySubscriptionComponent;