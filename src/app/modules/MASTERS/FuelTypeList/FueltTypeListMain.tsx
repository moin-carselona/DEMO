...
//  to fetch data on first time rendering 
    ...
    <div>
      {
        isLoading ?
          ...
          <DataTable
            ...
            actions={
              <>
              <button className="btn btn-sm btn-primary" onClick={(row) => handleAddFueltype()}><i className="fa fa-plus-circle mr-2"></i>Add Service Price</button>
 ...
 {PopUpPostFormOpen && <DialogBox PopUpFuelTypeBTN={handleAddFueltype} PopUpPostFormOpen={PopUpPostFormOpen} />}
      
    </div>
  )
}
export default FueltTypeListMain
