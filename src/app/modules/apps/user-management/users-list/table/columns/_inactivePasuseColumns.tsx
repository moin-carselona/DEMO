...
const inactivePauseColumns: ReadonlyArray<Column<User>> = [
  {
    Header: (props) => (
  ...
  {
    Header: (props) => (
      <UserCustomHeader tableProps={props} title='Reason' className='min-w-225px' />
    ),
  ...
  {
    Header: (props) => (
      <UserCustomHeader tableProps={props} title='Society' className='min-w-auto' />
    ),
    accessor: 'jobsitename',
  },
  {
    Header: (props) => (
      <UserCustomHeader tableProps={props} title='Package' className='min-w-auto' />
    ),
