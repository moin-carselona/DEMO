...
import { RenewalActionCells } from './RenewalActionCells'


const renewalColumns: ReadonlyArray<Column<User>> = [
  {
    Header: (props) => (
      <UserCustomHeader tableProps={props} title='Actions' />
    ),
    id: 'actions',
    Cell: ({ ...props }) => <RenewalActionCells id={props.data[props.row.index].id} />,
  },
  {
