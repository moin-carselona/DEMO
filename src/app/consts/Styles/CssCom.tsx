...
export const PopCloseFormNotificationPtag: CSS.Properties = { textAlign: "center", width: "5%", marginLeft: "95%", fontWeight: "700", color: "black", cursor: "pointer" }
...
export const maxwidth: CSS.Properties = { maxHeight: "30% !important"  }

export const Desc_InputCss: CSS.Properties = { width: "205px" }
export const ContainerCss: CSS.Properties = { width: "600px" }
export const ContainerCssCus: CSS.Properties = { width: "600px", height:"350px" }
